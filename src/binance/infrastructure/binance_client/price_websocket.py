...
class PriceWebSocketConnector:
    ...
    def __init__(
        self,
        symbol: str,
        on_price_update: Optional[Callable[[PriceData], None]] = None,
        on_connection_event: Optional[Callable[[str, Dict[str, Any]], None]] = None,
    ):
        """初始化价格WebSocket连接器
    ...
    def _parse_agg_trade_data(self, data: Dict[str, Any]) -> Optional[PriceData]:
        """解析聚合交易数据

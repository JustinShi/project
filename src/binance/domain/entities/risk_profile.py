...
class RiskProfile:
    ...
    def is_trading_allowed(self, current_time: datetime) -> bool:
        ...
        return not (current_hour < self.trading_hours_start or current_hour >= self.trading_hours_end)
    ...
    def should_pause_trading(self, consecutive_losses: int, daily_loss: Decimal) -> bool:
        """检查是否应该暂停交易"""

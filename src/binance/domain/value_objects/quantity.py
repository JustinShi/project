...
class Quantity:
    ...
    def __init__(self, value: str | float | Decimal, precision: int = 6):
        """初始化数量
    ...
    def multiply(self, factor: Decimal | float) -> "Quantity":
        """乘法运算
    ...
    def divide(self, divisor: Decimal | float) -> "Quantity":
        """除法运算
